    ...
    <main className="min-h-screen bg-slate-950 px-4 py-8 text-slate-100 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <section className="rounded-2xl border border-slate-700 bg-slate-900/90 p-5">
          ...
          <form action={updateStudentAction} encType="multipart/form-data" className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <label className="space-y-2">
              ...
              />
              <p className="text-xs text-slate-400">Opcional. Se enviar arquivo, ele substitui a URL manual.</p>
            </label>
